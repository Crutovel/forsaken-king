...
public class StartSurface extends SurfaceView {

    private SurfaceHolder holder;
    private StartLoopThread loopThread;
    private Scene currentScene;


    public StartSurface(Context context) {
        super(context);
    ...
    public void setThread(StartLoopThread thread) {
